...
Notice it deduplicated the "iF(st(isleaf,q1)" by naming it n17. Strangely, every tab level deeper is a self contained function, as is every left and right child of everything, like {,ifElse {,isleaf q1}} is a self contained function, and {,isleaf q1} is a self contained function, and ,isleaf is a self contained function aka (t isleaf), and all of them eventually are made of a single function aka wikibinator106.
